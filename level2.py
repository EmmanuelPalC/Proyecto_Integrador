...
class Level2:
    ...
    def create_map(self):
        layout = {
            'boundary': import_csv_layout('assets/mapa2/MAPA2 (1)_boundaries.csv'),
            ...
            'entities2':import_csv_layout('assets/mapa2/MAPAAAAA_entities.csv'),
        }
            ...
            for row_index,row in enumerate(layout):
                    for col_index, col in enumerate(row):
                        if col != '-1':
                            ...
                            if style == 'entities2':
                                Enemy2('fire',(x,y),[self.visible_sprites,
        ...
        self.player = Player2((450,280),[self.visible_sprites],self.obstacles_sprites,self.create_attack,self.destroy_attack)
...
class YsortCameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        #creating the floor
        self.floor_surf=pygame.image.load('assets/mapa2/MAPA2 (1).png').convert()
